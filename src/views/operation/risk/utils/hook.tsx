...
//   getAllRoleList
// } from "@/api/system";
import { getRisk, addRisk, delRisk, reRisk } from "@/api/operation";
import {
  type Ref,
  h,
  ref,
...
export function useUser(tableRef: Ref) {
  ...
  function onbatchDel() {
    ...
    delRisk({ ids: getKeyList(curSelected, "riskId") });
  ...
  async function onSearch() {
    loading.value = true;
    const { data } = await getRisk(toRaw(form));
